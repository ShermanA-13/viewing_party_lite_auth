...
RSpec.describe 'landing page' do
  before do
    @user_1 = User.create!(name: 'user_1', email: 'test_5@gmail.com', password: '1234', password_confirmation: '1234')
    @user_2 = User.create!(name: 'user_2', email: 'test_3@gmail.com', password: '1234', password_confirmation: '1234')
