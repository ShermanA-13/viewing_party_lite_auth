...
RSpec.describe 'create a new viewing party' do
  before(:each) do
    @user1 = User.create!(name: 'Max', email: 'max@yahoo.com', password: '1234', password_confirmation: '1234')
    @user2 = User.create!(name: 'Susan', email: 'susan@yahoo.com', password: '1234', password_confirmation: '1234')
    @user3 = User.create!(name: 'Sherman', email: 'sherman@yahoo.com', password: '1234', password_confirmation: '1234')
    @user4 = User.create!(name: 'Joseph', email: 'joseph@yahoo.com', password: '1234', password_confirmation: '1234')
